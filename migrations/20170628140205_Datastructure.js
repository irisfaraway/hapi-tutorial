...
exports.up = function(knex, Promise) {
  return knex.schema
             .createTable('users', function(usersTable) {
               ...
               // Why is this guid 50 here and 36 elsewhere? Whatever, I'll leave it
             ...
             .createTable('birds', function(birdsTable) {
               ...
               // For example, in the line below, we create a column named `name` which has a maximum
               // length of 250 characters, is of type string (VARCHAR) and is not nullable.
...
exports.down = function(knex, Promise) {
  ...
  // We also drop the referencing table first (in this case, birds) to avoid errors.
  return knex.schema
